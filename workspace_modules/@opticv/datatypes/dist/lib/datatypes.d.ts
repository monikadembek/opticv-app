...
export type LimitedFeature = 'CV_OPTIMIZATION' | 'COVER_LETTER' | 'INTERVIEW_PREP' | 'LINKEDIN';
...
export declare function getEffectiveTier(tier: SubscriptionTier, status: SubscriptionStatus): SubscriptionTier;
...
export type UploadCvResponse = Pick<CvDocument, 'id' | 'fileName' | 'fileSize' | 'mimeType' | 'storageKey' | 'createdAt' | 'parseStatus'>;
export type CvDocumentListItem = Pick<CvDocument, 'id' | 'fileName' | 'fileSize' | 'mimeType' | 'createdAt' | 'parsedText' | 'parseStatus'>;
...
export type SummaryRewriteVariantAngle = 'achievement_led' | 'identity_led' | 'mission_led';
...
export type InterviewPrepQuestion = {
    question: string;
    category: 'behavioral' | 'technical' | 'situational' | 'fit' | 'candidate_specific' | 'leadership' | 'culture';
...
export type LinkedInHeadlineAngle = 'title_specialty_value' | 'outcome_focused' | 'story_focused';
...
export type LinkedInRecommendationSection = 'skills' | 'featured' | 'experience' | 'education' | 'certifications' | 'url' | 'photo' | 'banner' | 'recommendations' | 'activity';
