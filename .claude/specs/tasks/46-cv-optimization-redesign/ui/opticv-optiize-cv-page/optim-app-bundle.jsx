  ...
  return (
    <header className="app-header">
      <a className="app-header__logo" href="#">
        <img src={window.__resources?.logoIcon || "assets/opticv-logo-icon.svg"} alt="OptiCV" />
  ...
  return (
    <>
      ...
      <TweaksPanel>
        ...
        <TweakRadio label="Layout" value={tweaks.layoutMode} options={["scroll", "tabs"]} onChange={(v) => setTweak("layoutMode", v)} />
        <TweakRadio label="Export" value={tweaks.exportPlacement} options={["section", "footer"]} onChange={(v) => setTweak("exportPlacement", v)} />
