...
Landing page for OptiCV app has already been created in Astro framework and is accessible under url:
https://limegreen-fox-593309.hostingersite.com/

I would like to improve UI of this app to make it more similar to the layout of OptiCV landing page.
At first we will start with adjusting top header and navigation.
Adjust top header to be similar to Top Navigation bar on landing page.
Put logo opticv-logo-icon.svg. On menu links apply the styles similar to the one from landing page.
Don't add light/dark mode switcher. This will be added in the future.

Below is the content of file NavigationBar.astro used in landing page. Maybe you can reuse some styles.
...
<style>
	...
	.header__logo {
		@apply flex flex-auto items-center gap-2 whitespace-nowrap py-3 text-3xl font-bold tracking-wider text-primary-700 focus:outline-none;
	}
	.header__nav {
