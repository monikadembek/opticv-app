Task 117. Implement CV Builder feature

Description:

We need to implement CV builder feature that allows users to biuld their CV from scratch.
Below is the reasearch I did earlier with Claude Code.
...
Made decision regarding limits:
- Allow building 1 cv from scratch for Free account
- allow building 5 CVs from scratch for Basic account monthly
- allow building 10CVs from scratch monthly for Pro account
